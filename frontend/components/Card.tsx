  ...
  return (
    <Link href={`/app/chats?id=${user.id}`} >
        <div className="relative h-60 text-slate-100 m-1 block cursor-pointer">
            ...
            <p className={`z-30 inline absolute p-2 bottom-2 right-2 opacity-75 ${online ? 'bg-green-400 text-green-900': 'bg-red-400 text-red-900'} rounded-full h-9 w-20 text-center font-extrabold`}>
